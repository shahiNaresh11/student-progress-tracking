                ...
                >
                    ...
                    <nav className="space-y-2">
                        <Link
                            ...
                            className={`flex items-center ${sidebarOpen ? 'space-x-3' : 'justify-center'} w-full px-4 py-3 text-left
                                text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg 
                                transition-colors`}>
                        ...
                        <Link
                            to="/records"
                            className={`flex items-center ${sidebarOpen ? 'space-x-3' : 'justify-center'} w-full px-4 py-3 text-left
                             text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg transition-colors`}>
                            <Clock size={18} />
                        ...
                        <Link
                            to="/profile"
                            className={`flex items-center ${sidebarOpen ? 'space-x-3' : 'justify-center'} w-full px-4 py-3 text-left text-gray-700 hover:bg-indigo-50 hover:text-indigo-700 rounded-lg transition-colors`}>
                            <User size={18} />
